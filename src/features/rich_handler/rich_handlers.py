...
class DataLoaderHandler:
    ...
    def create_data_progress(self, description: str = "Loading Data") -> Progress:
        """
    ...
    def log_transform_info(self, transforms_info: List[str]):
        ...
        panel = Panel(
            transforms_text, title="🔄 Data Transforms", style="blue", border_style="blue"
        )
...
class TrainingHandler:
    ...
    def start_training(self, total_epochs: int, batches_per_epoch: int) -> Layout:
        """
        Initialize training progress bars and layout.
        ...
        Returns:
            Layout: Rich Layout object containing progress bars.
        """
    ...
    def update_epoch_metrics(
        ...
        """
        Update and display epoch metrics in a rich table.
    ...
    def log_loss_components(self, loss_dict: Dict[str, float], epoch: int, batch: int):
        ...
        table = Table(
            title=f"🎯 Loss Components - Epoch {epoch}, Batch {batch}",
            show_header=True,
    ...
    def create_training_progress(self):
        ...
        return Progress(
            ...
            TextColumn("[yellow]Test Loss: {task.fields[test_loss]}"),
            TextColumn("•"),
            TimeElapsedColumn(),
            console=self.console,
        )
...
class ModelHandler:
    ...
    def log_model_architecture(self, model_info: Dict[str, Any]):
        ...
        table = Table(
            title="🤖 DETR Model Architecture", show_header=True, header_style="bold blue"
        )
...
@contextmanager
def rich_training_context(console: Optional[Console] = None):
    """
    ...
    Yields:
        TrainingHandler: Handler for training operations.
    """
...
@contextmanager
def rich_data_context(console: Optional[Console] = None):
    """
    ...
    Yields:
        DataLoaderHandler: Handler for data loading operations.
    """
...
def create_detection_live_display(console: Optional[Console] = None) -> Live:
    """
    ...
    Returns:
        Live: Rich Live object for real-time display.
    """
